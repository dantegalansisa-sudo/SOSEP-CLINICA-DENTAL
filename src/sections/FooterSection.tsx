  ...
  return (
    <footer className="footer">
      <div className="section-container">
        ...
        >
          <div>
            <div className="footer__logo">SOSEP DENTAL</div>
          ...
          <div className="footer__social">
            <a href="https://instagram.com/sosepdental" target="_blank" rel="noopener noreferrer" className="footer__social-link interactive" aria-label="Instagram">
