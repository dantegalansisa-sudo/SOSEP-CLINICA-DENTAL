        ...
        >
          <div className="map-section__info">
            <div className="map-section__detail">
              ...
              <span className="map-section__detail-value">Santo Domingo, República Dominicana</span>
            </div>
            <div className="map-section__detail">
            ...
            <div className="map-section__detail">
              ...
              <a href="https://instagram.com/sosepdental" target="_blank" rel="noopener noreferrer" className="map-section__detail-value map-section__link">@sosepdental</a>
            </div>
          </div>
          ...
          <div className="map-section__embed">
            <iframe
              ...
              title="Ubicación SOSEP Clínica Dental"
            />
          </div>
        </motion.div>
      </div>
