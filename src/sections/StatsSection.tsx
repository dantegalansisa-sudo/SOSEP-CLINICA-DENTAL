...
const stats = [
  { number: 5000, suffix: '+', unit: 'CASOS', label: 'Sonrisas Transformadas' },
  { number: 10, suffix: '+', unit: 'AÑOS', label: 'Años de Excelencia' },
  { number: 98, suffix: '%', unit: 'SAT.', label: 'Tasa de Satisfacción' },
  { number: 6, suffix: '', unit: 'SPECS', label: 'Especialidades Clínicas' },
];
