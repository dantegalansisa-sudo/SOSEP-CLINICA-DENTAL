...
const infoItems = [
  { icon: '📍', label: 'Dirección', value: 'Santo Domingo, República Dominicana' },
  { icon: '📞', label: 'Teléfono', value: 'Próximamente' },
  { icon: '⏰', label: 'Horario', value: 'Lun - Vie: 9:00 AM - 6:00 PM | Sáb: 9:00 AM - 2:00 PM' },
  { icon: '💬', label: 'WhatsApp', value: 'Próximamente' },
  { icon: '✉️', label: 'Instagram', value: '@sosepdental' },
];
    ...
    <div className="booking-cal__root">
      ...
      {selectedDay && selectedTime && (
        <motion.button
          ...
          onClick={() =>
            window.open(
              `https://wa.me/18090000000?text=Hola, quiero agendar una cita el ${selectedDay} de ${MONTH_NAMES[month]} a las ${selectedTime}.`,
              '_blank',
            )
          }
        >
