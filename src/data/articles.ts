...
export const articles: Article[] = [
  {
    ...
    readTime: '4 min',
    img: '/imagenes/sosep/blog-estetica.png',
    content: [
      ...
      'En SOSEP Clínica Dental evaluamos cada caso de forma personalizada. Durante tu consulta, analizaremos el estado de tus dientes, tus expectativas y tu presupuesto para recomendarte el tratamiento que mejor se adapte a ti.',
    ],
    tips: [
  ...
  },
  {
    ...
    readTime: '5 min',
    img: '/imagenes/sosep/blog-implantes.png',
    content: [
      ...
      'En SOSEP Clínica Dental utilizamos tecnología de diagnóstico 3D para planificar cada implante con precisión milimétrica, asegurando los mejores resultados posibles para cada paciente.',
    ],
    tips: [
  ...
  },
  {
    ...
    readTime: '3 min',
    img: '/imagenes/sosep/blog-prevencion.png',
    content: [
      ...
      'En SOSEP Clínica Dental creemos que la prevención es la mejor inversión en tu salud dental. Nuestro equipo está disponible para enseñarte las técnicas correctas y crear un plan de prevención personalizado.',
    ],
    tips: [
